        ...
        with open(filename,"r") as f:
            ...
            for endpoint_id in range(self.E):         
                ...
                for _ in range(num_cache):
                    ...
                    self.cache_servers[cache_id].connected_endpoint.append(endpoint_id)
            ...
            for request_id in range(self.R):
                video_id, endpoint_id, requests = map(int, f.readline().split())
                self.requests.append([video_id, endpoint_id, requests]) # request: [video_id, endpoint_id, requests]
